...
public class BusinessEntityMapper {
    ...
    public static RegistrationResponseDto toRegistrationResponseDto(BusinessPartner businessPartner) {
    ...
    public static CreateBusinessEntity toCreateBusinessEntity(RegistrationRequestDto registrationRequestDto) {
        return new CreateBusinessEntity()
            .name(registrationRequestDto.organizationName())
            .contactEmailAddress(registrationRequestDto.technicalEmailAddress());
    }

    public static UpdateBusinessEntity toUpdateBusinessEntity(UpdateRequestDto updateRequestDto) {
        return new UpdateBusinessEntity()
            .name(updateRequestDto.organizationName())
            .contactEmailAddress(updateRequestDto.technicalEmailAddress());
    }
}
