...
import {ProcessComponent} from '../../../../../app/shared/process/process.component';
...
@Component({
  ...
  imports: [TranslateModule, ObButtonDirective, MatAnchor, MatButton, MatIcon, ProcessComponent, ProcessStepComponent],
